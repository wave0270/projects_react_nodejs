    ...
    <div>
      ...
      <div className='carousel-wrapper horizontal-carousel-wrapper'>
        <div className='wrapper'>
          <div className='carousel horizontal-carousel clearfix owl-carousel owl-theme' data-pagination='true' style='display: block; margin-left: -14.9592px; width: 1113.92px; opacity: 1;'>
            <div className='owl-wrapper-outer'>
              <div className='owl-wrapper' style='width: 4452px; left: 0px; display: block;'>
                <div className='owl-item carousel-item-visible' style='width: 371px;'>
                  <div className='blog-post-s2 clearfix col col-3 col-first carousel-item  post-32 post type-post status-publish format-standard has-post-thumbnail hentry category-lifestyle tag-carousel-small' style='padding-left: 14.9592px; padding-right: 14.9592px;'>
                    ...
                    { /* <!-- .blog-post-s2-thumb --> */}
                    <div className='blog-post-s2-title' style='padding-top: 7px;'>
                ...
                <div className='owl-item carousel-item-visible' style='width: 371px;'>
                  <div className='blog-post-s2 clearfix col col-3 carousel-item  post-31 post type-post status-publish format-standard has-post-thumbnail hentry category-fashion tag-carousel-small' style='padding-left: 14.9592px; padding-right: 14.9592px;'>
                    <div className='blog-post-s2-thumb'>
                ...
                <div className='owl-item carousel-item-visible' style='width: 371px;'>
                  <div className='blog-post-s2 clearfix col col-3 carousel-item  post-30 post type-post status-publish format-standard has-post-thumbnail hentry category-beauty tag-carousel-small' style='padding-left: 14.9592px; padding-right: 14.9592px;'>
                    <div className='blog-post-s2-thumb'>
                ...
                <div className='owl-item' style='width: 371px;'>
                  <div className='blog-post-s2 clearfix col col-3 col-last carousel-item  post-29 post type-post status-publish format-standard has-post-thumbnail hentry category-lifestyle tag-carousel-small' style='padding-left: 14.9592px; padding-right: 14.9592px;'>
                    <div className='blog-post-s2-thumb'>
                    ...
                    { /* <!-- .blog-post-s2-thumb --> */}
                    <div className='blog-post-s2-title' style='padding-top: 1.25px;'>
                ...
                <div className='owl-item' style='width: 371px;'>
                  <div className='blog-post-s2 clearfix col col-3 col-first carousel-item  post-28 post type-post status-publish format-standard has-post-thumbnail hentry category-fashion tag-carousel-small' style='padding-left: 14.9592px; padding-right: 14.9592px;'>
                    <div className='blog-post-s2-thumb'>
                ...
                <div className='owl-item' style='width: 371px;'>
                  <div className='blog-post-s2 clearfix col col-3 carousel-item  post-27 post type-post status-publish format-standard has-post-thumbnail hentry category-beauty tag-carousel-small' style='padding-left: 14.9592px; padding-right: 14.9592px;'>
                    <div className='blog-post-s2-thumb'>
      ...
      <div className='carousel-wrapper vertical-carousel-wrapper'>
        <div className='wrapper'>
          <div className='carousel vertical-carousel clearfix owl-carousel owl-theme' data-pagination='false' style='display: block; margin-left: -14.9592px; width: 1113.92px; opacity: 1;'>
            <div className='owl-wrapper-outer'>
              <div className='owl-wrapper' style='width: 3710px; left: 0px; display: block;'>
                <div className='owl-item carousel-item-visible' style='width: 371px;'>
                  <div className='blog-post-s3 clearfix col col-3 col-first carousel-item  post-39 post type-post status-publish format-standard has-post-thumbnail hentry category-travel tag-beauty tag-carousel tag-hair tag-style' style='padding-left: 14.9592px; padding-right: 14.9592px;'>
                ...
                <div className='owl-item carousel-item-visible' style='width: 371px;'>
                  <div className='blog-post-s3 clearfix col col-3 carousel-item  post-38 post type-post status-publish format-standard has-post-thumbnail hentry category-personal tag-carousel' style='padding-left: 14.9592px; padding-right: 14.9592px;'>
                    <div className='blog-post-s3-thumb'>
                ...
                <div className='owl-item carousel-item-visible' style='width: 371px;'>
                  <div className='blog-post-s3 clearfix col col-3 carousel-item  post-36 post type-post status-publish format-standard has-post-thumbnail hentry category-personal tag-carousel' style='padding-left: 14.9592px; padding-right: 14.9592px;'>
                    <div className='blog-post-s3-thumb'>
                ...
                <div className='owl-item' style='width: 371px;'>
                  <div className='blog-post-s3 clearfix col col-3 col-last carousel-item  post-35 post type-post status-publish format-standard has-post-thumbnail hentry category-travel tag-beauty tag-carousel tag-hair tag-style' style='padding-left: 14.9592px; padding-right: 14.9592px;'>
                    <div className='blog-post-s3-thumb'>
                ...
                <div className='owl-item' style='width: 371px;'>
                  <div className='blog-post-s3 clearfix col col-3 col-first carousel-item  post-33 post type-post status-publish format-standard has-post-thumbnail hentry category-personal tag-beauty tag-carousel tag-hair tag-style' style='padding-left: 14.9592px; padding-right: 14.9592px;'>
                    <div className='blog-post-s3-thumb'>
      ...
      <div className='promo-boxes clearfix'>
        <div className='wrapper'>
          <div className='promo-box promo-box-1 col col-4' style='background-image:url(http://meridianthemes-demo.net/the-essence/wp-content/uploads/sites/4/2016/04/box1-1.jpg)' data-mtst-selector='.promo-box' data-mtst-label='Promo Box' data-mtst-no-support='typography'>
          ...
          { /* <!-- .promo-box --> */}
          <div className='promo-box promo-box-2 col col-4' style='background-image:url(http://meridianthemes-demo.net/the-essence/wp-content/uploads/sites/4/2016/04/box2-1.jpg)'>
          ...
          { /* <!-- .promo-box --> */}
          <div className='promo-box promo-box-3 col col-4 col-last' style='background-image:url(http://meridianthemes-demo.net/the-essence/wp-content/uploads/sites/4/2016/04/box3-1.jpg)'>
            <div className='promo-box-inner'>
          ...
          <aside id='sidebar' className='col col-4 col-last'>
            <div id='sidebar-inner'>
              ...
              <section id='the_essence_subscribe_widget-3' className='widget widget_the_essence_subscribe_widget'>
                ...
                <div className='subscribe-widget' style='background-image:url(http://meridianthemes-demo.net/the-essence/wp-content/uploads/sites/4/2016/04/news-1.jpg);' data-mtst-selector='.subscribe-widget' data-mtst-label='Subscribe' data-mtst-no-support='typography'>
