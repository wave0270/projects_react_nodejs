...
if (process.env.BROWSER) require('styles/layout-news/validationEngine.jquery.css')
    ...
    return (
      <div>
        <div id="page" className="site">
          <div id="top-bar" data-mtst-selector="#top-bar" data-mtst-label="Top Bar" data-mtst-no-support="typography,border">
            <div className="wrapper clearfix">
              ...
              <div id="top-bar-social" className="clearfix" data-mtst-selector="#top-bar-social a" data-mtst-label="Top Bar - Social" data-mtst-no-support="background,border">
                <a href="http://meridianthemes-demo.net/the-essence/#" target="_blank"><span className="fa fa-twitter-square" /></a>
                <a href="http://meridianthemes-demo.net/the-essence/#" target="_blank"><span className="fa fa-facebook-square" /></a>
                <a href="http://meridianthemes-demo.net/the-essence/#" target="_blank"><span className="fa fa-youtube-square" /></a>
                <a href="http://meridianthemes-demo.net/the-essence/#" target="_blank"><span className="fa fa-vimeo-square" /></a>
                <a href="http://meridianthemes-demo.net/the-essence/#" target="_blank"><span className="fa fa-pinterest-square" /></a>
              </div>
              {/* .top-bar-social */}
            </div>
            {/* .wrapper */}
              ...
              <div id="logo" data-mtst-selector="#logo" data-mtst-label="Logo" data-mtst-no-support="typography,border">
                <h2>
                  <a href="http://meridianthemes-demo.net/the-essence/" rel="home">
                    ...
                    <img className="has-retina-ver" src="/styles/layout-news/image/logo.png" data-retina-ver="http://meridianthemes-demo.net/the-essence/wp-content/uploads/sites/4/2016/04/logoretina.png" alt="The Essence" />
                  </a>
                </h2>
              </div>
              {/* #logo */}
              <nav id="navigation" className>
                <div id="navigation-panel-hook"><span className="fa fa-align-left" /></div>
                <div id="navigation-main" data-mtst-selector="#navigation .menu > li > a" data-mtst-label="Navigation Items" data-mtst-no-support="background,border">
                  <div className="menu-primary-container">
                    <ul id="primary-menu" className="menu">
                      <li id="menu-item-6" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-4 current_page_item current-menu-ancestor current_page_ancestor menu-item-has-children menu-item-6"><a href="http://meridianthemes-demo.net/the-essence/">Home<span className="fa fa-chevron-down" /></a>
                      ...
                      <li id="menu-item-151" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-151"><a href="http://meridianthemes-demo.net/the-essence/#">Social<span className="fa fa-chevron-down" /></a>
                        <ul className="sub-menu">
                ...
                <div id="navigation-search-hook"><span className="fa fa-search" /><span className="fa fa-close" /></div>
              </nav>
              {/* #navigation */}
            </div>
            {/* .wrapper */}
          ...
          <div className="carousel-wrapper horizontal-carousel-wrapper">
            <div className="wrapper">
              <div className="carousel horizontal-carousel clearfix owl-carousel owl-theme" data-pagination="true" style={{ display: 'block', marginLeft: '-14.9592px', width: '1113.92px', opacity: 1 }}>
                <div className="owl-wrapper-outer">
                  <div className="owl-wrapper" style={{ width: 4452, left: 0, display: 'block' }}>
                    <div className="owl-item carousel-item-visible" style={{ width: 371 }}>
                      <div className="blog-post-s2 clearfix col col-3 col-first carousel-item  post-32 post type-post status-publish format-standard has-post-thumbnail hentry category-lifestyle tag-carousel-small" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                        ...
                        {/* .blog-post-s2-thumb */}
                        <div className="blog-post-s2-title" style={{ paddingTop: 7 }}>
                          <h4 data-mtst-selector=".blog-post-s2-title h4" data-mtst-label="Blog Post S2 - Title"><a href="http://meridianthemes-demo.net/the-essence/2016/04/06/republicans-say-theyre-embarrassed-by-trump-but-voting-for-him-anyway/">Republicans Say They’re Embarrassed by Trump but Voting for Him Anyway</a></h4>
                        </div>
                        {/* .blog-post-s2-title */}
                      </div>
                    </div>
                    <div className="owl-item carousel-item-visible" style={{ width: 371 }}>
                      <div className="blog-post-s2 clearfix col col-3 carousel-item  post-31 post type-post status-publish format-standard has-post-thumbnail hentry category-fashion tag-carousel-small" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                        <div className="blog-post-s2-thumb">
                    ...
                    <div className="owl-item carousel-item-visible" style={{ width: 371 }}>
                      <div className="blog-post-s2 clearfix col col-3 carousel-item  post-30 post type-post status-publish format-standard has-post-thumbnail hentry category-beauty tag-carousel-small" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                        <div className="blog-post-s2-thumb">
                    ...
                    <div className="owl-item" style={{ width: 371 }}>
                      <div className="blog-post-s2 clearfix col col-3 col-last carousel-item  post-29 post type-post status-publish format-standard has-post-thumbnail hentry category-lifestyle tag-carousel-small" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                        <div className="blog-post-s2-thumb">
                        ...
                        {/* .blog-post-s2-thumb */}
                        <div className="blog-post-s2-title" style={{ paddingTop: '1.25px' }}>
                          <h4 data-mtst-selector=".blog-post-s2-title h4" data-mtst-label="Blog Post S2 - Title"><a href="http://meridianthemes-demo.net/the-essence/2016/04/06/why-the-night-managers-elizabeth-debicki-is-every-costume-designers-dream-come-true/">Why The Night Manager’s Elizabeth Debicki Is Every Costume Designer’s Dream Come True</a></h4>
                        </div>
                        {/* .blog-post-s2-title */}
                      </div>
                    </div>
                    <div className="owl-item" style={{ width: 371 }}>
                      <div className="blog-post-s2 clearfix col col-3 col-first carousel-item  post-28 post type-post status-publish format-standard has-post-thumbnail hentry category-fashion tag-carousel-small" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                        <div className="blog-post-s2-thumb">
                        ...
                        {/* .blog-post-s2-thumb */}
                        <div className="blog-post-s2-title" style={{ paddingTop: 7 }}>
                          <h4 data-mtst-selector=".blog-post-s2-title h4" data-mtst-label="Blog Post S2 - Title"><a href="http://meridianthemes-demo.net/the-essence/2016/04/06/5-reasons-why-well-never-see-anything-like-the-o-j-simpson-verdict-again/">5 Reasons Why We’ll Never See Anything Like the O.J. Simpson Verdict Again</a></h4>
                        </div>
                        {/* .blog-post-s2-title */}
                      </div>
                    </div>
                    <div className="owl-item" style={{ width: 371 }}>
                      <div className="blog-post-s2 clearfix col col-3 carousel-item  post-27 post type-post status-publish format-standard has-post-thumbnail hentry category-beauty tag-carousel-small" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                        <div className="blog-post-s2-thumb">
                        ...
                        {/* .blog-post-s2-thumb */}
                        <div className="blog-post-s2-title" style={{ paddingTop: 7 }}>
                          <h4 data-mtst-selector=".blog-post-s2-title h4" data-mtst-label="Blog Post S2 - Title"><a href="http://meridianthemes-demo.net/the-essence/2016/04/06/harry-styles-had-to-fend-off-selfie-seeking-fan-at-grandmothers-funeral/">Harry Styles Had to Fend Off Selfie-Seeking Fan at Grandmother’s Funeral</a></h4>
                        </div>
                        {/* .blog-post-s2-title */}
                      </div>
                    </div>
          ...
          <div className="carousel-wrapper vertical-carousel-wrapper">
            <div className="wrapper">
              <div className="carousel vertical-carousel clearfix owl-carousel owl-theme" data-pagination="false" style={{ display: 'block', marginLeft: '-14.9592px', width: '1113.92px', opacity: 1 }}>
                <div className="owl-wrapper-outer">
                  <div className="owl-wrapper" style={{ width: 3710, left: 0, display: 'block' }}>
                    <div className="owl-item carousel-item-visible" style={{ width: 371 }}>
                      <div className="blog-post-s3 clearfix col col-3 col-first carousel-item  post-39 post type-post status-publish format-standard has-post-thumbnail hentry category-travel tag-beauty tag-carousel tag-hair tag-style" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                        ...
                        <div className="blog-post-s3-main">
                          ...
                          <div className="blog-post-s3-meta">
                            ...
                            <span className="blog-post-s3-meta-separator" />
                            <span className="blog-post-s3-meta-date" data-mtst-selector=".blog-post-s3-meta-date" data-mtst-label="Blog Post S2 - Date" data-mtst-no-support="spacing,background,border">
                              10 months ago			</span>
                    ...
                    <div className="owl-item carousel-item-visible" style={{ width: 371 }}>
                      <div className="blog-post-s3 clearfix col col-3 carousel-item  post-38 post type-post status-publish format-standard has-post-thumbnail hentry category-personal tag-carousel" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                        <div className="blog-post-s3-thumb">
                        ...
                        {/* .blog-post-s3-thumb */}
                        <div className="blog-post-s3-main">
                          <h4 className="blog-post-s3-title" data-mtst-selector=".blog-post-s3-title" data-mtst-label="Blog Post S3 - Title" data-mtst-no-support="border,background"><a href="http://meridianthemes-demo.net/the-essence/2016/04/06/leon-bridges-and-andra-day-rbs-rising-stars-talk-teaming-up/">Leon Bridges and Andra Day, R&amp;B’s Rising Stars, Talk Teaming Up</a></h4>
                          <div className="blog-post-s3-meta">
                            <span className="blog-post-s3-meta-author" data-mtst-selector=".blog-post-s3-meta-author a" data-mtst-label="Blog Post S2 - Author" data-mtst-no-support="spacing,background,border">
                              <a href="http://meridianthemes-demo.net/the-essence/author/0176wpczar/" title="Posts by Carley Keener" rel="author">Carley Keener</a>			</span>
                            {/* .blog-post-s3-meta-author */}
                    ...
                    <div className="owl-item carousel-item-visible" style={{ width: 371 }}>
                      <div className="blog-post-s3 clearfix col col-3 carousel-item  post-36 post type-post status-publish format-standard has-post-thumbnail hentry category-personal tag-carousel" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                        <div className="blog-post-s3-thumb">
                    ...
                    <div className="owl-item" style={{ width: 371 }}>
                      <div className="blog-post-s3 clearfix col col-3 col-last carousel-item  post-35 post type-post status-publish format-standard has-post-thumbnail hentry category-travel tag-beauty tag-carousel tag-hair tag-style" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                        <div className="blog-post-s3-thumb">
                    ...
                    <div className="owl-item" style={{ width: 371 }}>
                      <div className="blog-post-s3 clearfix col col-3 col-first carousel-item  post-33 post type-post status-publish format-standard has-post-thumbnail hentry category-personal tag-beauty tag-carousel tag-hair tag-style" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                        <div className="blog-post-s3-thumb">
              ...
              {/* .vertical-carousel */}
              <span className="carousel-nav-prev"><span className="fa fa-angle-left" /></span>
              <span className="carousel-nav-next"><span className="fa fa-angle-right" /></span>
            </div>
            {/* .wrapper */}
          </div>
          ...
          <div className="promo-boxes clearfix">
            <div className="wrapper">
              <div className="promo-box promo-box-1 col col-4" style={{ backgroundImage: 'url(http://meridianthemes-demo.net/the-essence/wp-content/uploads/sites/4/2016/04/box1-1.jpg)' }} data-mtst-selector=".promo-box" data-mtst-label="Promo Box" data-mtst-no-support="typography">
                ...
                {/* .promo-box-inner */}
                <a href="http://meridianthemes-demo.net/the-essence/about/" className="promo-box-link" />
              </div>
              {/* .promo-box */}
              <div className="promo-box promo-box-2 col col-4" style={{ backgroundImage: 'url(http://meridianthemes-demo.net/the-essence/wp-content/uploads/sites/4/2016/04/box2-1.jpg)' }}>
                ...
                {/* .promo-box-inner */}
                <a href="http://meridianthemes-demo.net/the-essence/2016/04/06/how-bette-davis-became-an-icon-by-refusing-to-conform-at-every-turn/" className="promo-box-link" />
              </div>
              {/* .promo-box */}
              <div className="promo-box promo-box-3 col col-4 col-last" style={{ backgroundImage: 'url(http://meridianthemes-demo.net/the-essence/wp-content/uploads/sites/4/2016/04/box3-1.jpg)' }}>
                <div className="promo-box-inner">
                  <div className="promo-box-secondary">Discover</div>
                  <h2 className="promo-box-primary">My Travels</h2>
                </div>
                {/* .promo-box-inner */}
                <a href="http://meridianthemes-demo.net/the-essence/category/travel/" className="promo-box-link" />
              </div>
              {/* .promo-box */}
            </div>
            {/* .wrapper */}
                ...
                <div className="blog-posts-listing blog-posts-listing-1_cs_12">
                  <div className="blog-posts-listing-inner clearfix">
                    <div className="blog-post clearfix col col-12 col-first col-last  post-39 post type-post status-publish format-standard has-post-thumbnail hentry category-travel tag-beauty tag-carousel tag-hair tag-style">
                      ...
                      <div className="blog-post-meta clearfix">
                        ...
                        <div className="blog-post-meta-separator" />
                        <div className="blog-post-meta-comments-count" data-mtst-selector=".blog-post-meta-comments-count" data-mtst-label="Blog S1 - Comment Count" data-mtst-no-support="border,background">
                          <span className="fa fa-commenting-o" data-mtst-selector=".blog-post-meta-comments-count .fa" data-mtst-label="Blog S1 - Comment Count Icon" data-mtst-no-support="border,background" />
                        ...
                        <div className="blog-post-meta-share">
                          ...
                          <a href="http://meridianthemes-demo.net/the-essence/#" className="social-link-google-plus" onClick="return the_essence_social_share(400, 300, 'https://plus.google.com/share?url=http://meridianthemes-demo.net/the-essence/2016/04/07/why-did-reed-krakoff-walk-away-from-his-brand/')"><span className="fa fa-google-plus" /></a>
                          <a href="mailto:someone@example.com?subject=Why%20Did%20Reed%20Krakoff%20Walk%20Away%20from%20His%20Brand%3F&body=Why%20Did%20Reed%20Krakoff%20Walk%20Away%20from%20His%20Brand%3F%20http%3A%2F%2Fmeridianthemes-demo.net%2Fthe-essence%2F2016%2F04%2F07%2Fwhy-did-reed-krakoff-walk-away-from-his-brand%2F" className="social-link-email"><span className="fa fa-envelope-o" /></a>
                        </div>
                      ...
                      <div className="blog-post-excerpt" data-mtst-selector=".blog-post-excerpt" data-mtst-label="Blog Post S1 - Excerpt">
                        <p><span className="blog-post-excerpt-big-cap">N</span>am ultrices orci nibh, eget malesuada nibh eleifend sit amet. Aliquam
                          laoreet diam ut quam fringilla egestas. Cras commodo erat quis congue pretium. Aliquam erat volutpat. Quisque elementum
                          tortor elit, ac porta leo ultrices id. Aliquam sit amet mattis mi. Donec facilisis consectetur interdum. </p>
                        <p>Curabitur aliquam consequat ullamcorper. Maecenas eget lectus commodo, laoreet nulla eu, viverra enim. Cum sociis
                        ...
                        <div className="related-posts clearfix">
                          <div className="col col-4  blog-post-s4">
                            ...
                            <div className="blog-post-s4-main">
                              <div className="blog-post-s4-meta">
                                ...
                                <span className="blog-post-s4-meta-separator" />
                          ...
                          <div className="col col-4  blog-post-s4">
                            ...
                            <div className="blog-post-s4-main">
                              ...
                              {/* .blog-post-s4-meta */}
                              <h4 className="blog-post-s4-title" data-mtst-selector=".related-posts .blog-post-s4-title" data-mtst-label="Related Post - Title" data-mtst-no-support="background,border,spacing"><a href="http://meridianthemes-demo.net/the-essence/2016/04/07/heres-how-you-can-check-if-your-partner-is-cheating-on-tinder/">Here’s How You Can Check if Your Partner Is Cheating on Tinder</a></h4>
                            </div>
                            {/* .blog-post-s4-main */}
                          </div>
                          {/* .blog-post-s4 */}
                    ...
                    <div className="blog-post clearfix col col-12 col-first col-last  post-79 post type-post status-publish format-standard has-post-thumbnail hentry category-beauty">
                      ...
                      <div className="blog-post-meta clearfix">
                        ...
                        <div className="blog-post-meta-separator" />
                        <div className="blog-post-meta-share">
                          <a href="http://meridianthemes-demo.net/the-essence/#" className="social-link-facebook" target="_blank" onClick="return the_essence_social_share(400, 300, 'http://www.facebook.com/share.php?u=http://meridianthemes-demo.net/the-essence/2016/04/07/sir-patrick-stewart-answers-the-proust-questionnaire/')"><span className="fa fa-facebook-square" /></a>
                          <a href="http://meridianthemes-demo.net/the-essence/#" className="social-link-pinterest" onClick="return the_essence_social_share(400, 300, 'https://pinterest.com/pin/create/button/?url=http://meridianthemes-demo.net/the-essence/2016/04/07/sir-patrick-stewart-answers-the-proust-questionnaire/&media=http://meridianthemes-demo.net/the-essence/wp-content/uploads/sites/4/2016/04/15.jpg')"><span className="fa fa-pinterest-square" /></a>
                          ...
                          <a href="http://meridianthemes-demo.net/the-essence/#" className="social-link-google-plus" onClick="return the_essence_social_share(400, 300, 'https://plus.google.com/share?url=http://meridianthemes-demo.net/the-essence/2016/04/07/sir-patrick-stewart-answers-the-proust-questionnaire/')"><span className="fa fa-google-plus" /></a>
                          <a href="mailto:someone@example.com?subject=Sir%20Patrick%20Stewart%20Answers%20the%20Proust%20Questionnaire&body=Sir%20Patrick%20Stewart%20Answers%20the%20Proust%20Questionnaire%20http%3A%2F%2Fmeridianthemes-demo.net%2Fthe-essence%2F2016%2F04%2F07%2Fsir-patrick-stewart-answers-the-proust-questionnaire%2F" className="social-link-email"><span className="fa fa-envelope-o" /></a>
                        </div>
                        {/* .blog-post-meta-share */}
                      </div>
                      {/* .blog-post-meta */}
                      ...
                      {/* .blog-post-thumb */}
                      <div className="blog-post-excerpt" data-mtst-selector=".blog-post-excerpt" data-mtst-label="Blog Post S1 - Excerpt">
                        <p><span className="blog-post-excerpt-big-cap">C</span>urabitur dolor leo, eleifend a mollis at, iaculis vitae erat. Integer
                          vulputate, erat nec tempus interdum, ipsum nisl tempor ligula, ac vehicula eros urna sit amet ex. Etiam non ex
                          nec purus ullamcorper lobortis tincidunt id nibh.</p>
                        <p>Sed ullamcorper lacus sed ullamcorper viverra. Curabitur vitae lacinia felis. Phasellus vitae dolor pellentesque,
                          varius lectus in, mollis leo. Maecenas eget lectus commodo, laoreet nulla eu, viverra enim.</p>
                      </div>
                      {/* .blog-post-excerpt */}
                      <div className="blog-post-read-more">
                        ...
                        <div className="related-posts clearfix">
                          ...
                          <div className="col col-4 col-last blog-post-s4">
                            ...
                            <div className="blog-post-s4-main">
                              ...
                              {/* .blog-post-s4-meta */}
                              <h4 className="blog-post-s4-title" data-mtst-selector=".related-posts .blog-post-s4-title" data-mtst-label="Related Post - Title" data-mtst-no-support="background,border,spacing"><a href="http://meridianthemes-demo.net/the-essence/2016/04/06/harry-styles-had-to-fend-off-selfie-seeking-fan-at-grandmothers-funeral/">Harry Styles Had to Fend Off Selfie-Seeking Fan at Grandmother’s Funeral</a></h4>
                            </div>
                            {/* .blog-post-s4-main */}
                          </div>
                          {/* .blog-post-s4 */}
                  ...
                  <div className="pagination pagination-type-loadmore">
                    <ul className="clearfix">
                      <li className="pagination-load-more active" data-mtst-selector=".pagination-load-more a" data-mtst-label="Pagination"><span className="pagination-load-more-line" />
                        <a href="http://meridianthemes-demo.net/the-essence/page/2/"><span className="fa fa-refresh" />LOAD MORE POSTS</a>
                      </li>
                    </ul>
                    <div className="load-more-temp" />
                  </div>
                  {/* .pagination */}
                </div>
                {/* .blog-posts-listing */}
              ...
              <aside id="sidebar" className="col col-4 col-last">
                <div id="sidebar-inner">
                  ...
                  <section id="the_essence_subscribe_widget-3" className="widget widget_the_essence_subscribe_widget">
                    ...
                    <div className="subscribe-widget" style={{ backgroundImage: 'url(http://meridianthemes-demo.net/the-essence/wp-content/uploads/sites/4/2016/04/news-1.jpg)' }} data-mtst-selector=".subscribe-widget" data-mtst-label="Subscribe" data-mtst-no-support="typography">
                      <div className="subscribe-widget-inner" data-mtst-selector=".subscribe-widget-inner" data-mtst-label="Subscribe Inner" data-mtst-no-support="typography">
                        ...
                        <div className="widget_wysija_cont shortcode_wysija">
                          <div id="msg-form-wysija-shortcode587e307fde346-1" className="wysija-msg ajax" />
                          <form id="form-wysija-shortcode587e307fde346-1" method="post" action="http://meridianthemes-demo.net/the-essence/#wysija" className="widget_wysija shortcode_wysija">
                            <p className="wysija-paragraph">
                              <input type="text" name="wysija[user][email]" className="wysija-input validate[required,custom[email]]" title="Your Email Address" placeholder="Your Email Address" defaultValue />
                              <span className="abs-req">
                                <input type="text" name="wysija[user][abs][email]" className="wysija-input validated[abs][email]" defaultValue />
                              </span>
                            </p>
                            <input className="wysija-submit wysija-submit-field" type="submit" defaultValue="Send" />
                            <input type="hidden" name="form_id" defaultValue={1} />
                            <input type="hidden" name="action" defaultValue="save" />
                            <input type="hidden" name="controller" defaultValue="subscribers" />
                            <input type="hidden" defaultValue={1} name="wysija-page" />
                            <input type="hidden" name="wysija[user_list][list_ids]" defaultValue={1} />
                          </form>
                        </div>
                        <h5 data-mtst-selector=".subscribe-widget h5" data-mtst-label="Subscribe Subtitle" data-mtst-no-support="background,border">Don’t Worry, I Don't Spam.</h5>
                      </div>
                    ...
                    <div className="posts-list-widget clearfix">
                      <div className="blog-post-s6 clearfix col col-12  post-37 post type-post status-publish format-standard has-post-thumbnail hentry category-travel tag-beauty tag-hair tag-style">
                        ...
                        <div className="blog-post-s6-main">
                          ...
                          <div className="blog-post-s6-comments" data-mtst-selector=".blog-post-s6-comments" data-mtst-label="Blog Post S6 - Title" data-mtst-no-support="background,border"><span className="fa fa-commenting-o" />4 comments</div>
                        </div>
                        {/* .blog-post-s6-main */}
                      </div>
                      {/* .blog-post-s6-post */}
                      <div className="blog-post-s6 clearfix col col-12  post-39 post type-post status-publish format-standard has-post-thumbnail hentry category-travel tag-beauty tag-carousel tag-hair tag-style">
                        ...
                        <div className="blog-post-s6-main">
                          ...
                          <div className="blog-post-s6-comments" data-mtst-selector=".blog-post-s6-comments" data-mtst-label="Blog Post S6 - Title" data-mtst-no-support="background,border"><span className="fa fa-commenting-o" />3 comments</div>
                        </div>
                        {/* .blog-post-s6-main */}
                      </div>
                      {/* .blog-post-s6-post */}
                      <div className="blog-post-s6 clearfix col col-12  post-76 post type-post status-publish format-standard has-post-thumbnail hentry category-travel tag-beauty tag-hair tag-style">
                        ...
                        {/* .blog-post-s6-thumb */}
                        <div className="blog-post-s6-main">
                          <div className="blog-post-s6-title" data-mtst-selector=".blog-post-s6-title" data-mtst-label="Blog Post S6 - Title" data-mtst-no-support="background,border"><a href="http://meridianthemes-demo.net/the-essence/2016/04/07/heres-how-you-can-check-if-your-partner-is-cheating-on-tinder/">Here’s How You Can Check if Your Partner Is Cheating on Tinder</a></div>
                          <div className="blog-post-s6-comments" data-mtst-selector=".blog-post-s6-comments" data-mtst-label="Blog Post S6 - Title" data-mtst-no-support="background,border"><span className="fa fa-commenting-o" />3 comments</div>
                        </div>
                        {/* .blog-post-s6-main */}
                      </div>
                  ...
                  <section id="the_essence_social_widget-2" className="widget widget_the_essence_social_widget">
                    ...
                    <div className="social-widget">
                      <a className="social-link-twitter" href="http://meridianthemes-demo.net/the-essence/#" target="_blank"><span className="fa fa-twitter" /></a>
                      <a className="social-link-facebook" href="http://meridianthemes-demo.net/the-essence/#" target="_blank"><span className="fa fa-facebook" /></a>
                      <a className="social-link-youtube" href="http://meridianthemes-demo.net/the-essence/#" target="_blank"><span className="fa fa-youtube-play" /></a>
                      <a className="social-link-vimeo" href="http://meridianthemes-demo.net/the-essence/#" target="_blank"><span className="fa fa-vimeo" /></a>
                      <a className="social-link-pinterest" href="http://meridianthemes-demo.net/the-essence/#" target="_blank"><span className="fa fa-pinterest" /></a>
                    </div>
                    {/* .subscribe-widget */}
                  </section>
                  ...
                  <section id="the_essence_posts_list_alt_widget-2" className="widget widget_the_essence_posts_list_alt_widget">
                    ...
                    <div className="posts-list-alt-widget clearfix">
                      <div className="blog-post-s7 clearfix col col-12 col-first col-last  post-39 post type-post status-publish format-standard has-post-thumbnail hentry category-travel tag-beauty tag-carousel tag-hair tag-style">
                        ...
                        {/* .blog-post-s7-thumb */}
                        <div className="blog-post-s7-number" data-mtst-selector=".blog-post-s7-number" data-mtst-label="Blog Post S7 - Number" data-mtst-no-support="background,border">
                          01 </div>
                        {/* .blog-post-s7-number */}
          ...
          <div id="footer-posts" data-mtst-selector="#footer-posts" data-mtst-label="Footer Posts" data-mtst-no-support="typogrpahy,border">
            <div className="wrapper">
              ...
              <div className="carousel-wrapper">
                <div className="carousel clearfix owl-carousel owl-theme" data-pagination="false" data-items={4} style={{ display: 'block', marginLeft: '-14.9592px', width: '1113.92px', opacity: 1 }}>
                  <div className="owl-wrapper-outer">
                    <div className="owl-wrapper" style={{ width: 6696, left: 0, display: 'block' }}>
                      <div className="owl-item carousel-item-visible" style={{ width: 279 }}>
                        <div className="blog-post-s5 col col-3 col-first carousel-item  post-37 post type-post status-publish format-standard has-post-thumbnail hentry category-travel tag-beauty tag-hair tag-style" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                          ...
                          <div className="blog-post-s5-meta">
                            ...
                            <div className="blog-post-s5-meta-date" data-mtst-selector=".blog-post-s5-meta-date" data-mtst-label="Blog Post S5 - Date" data-mtst-no-support="background,border">
                              10 months ago </div>
                      ...
                      <div className="owl-item carousel-item-visible" style={{ width: 279 }}>
                        <div className="blog-post-s5 col col-3 carousel-item  post-76 post type-post status-publish format-standard has-post-thumbnail hentry category-travel tag-beauty tag-hair tag-style" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                          <div className="blog-post-s5-thumb" data-mtst-selector=".blog-post-s5-thumb" data-mtst-label="Blog Post S5 - Thumbnail" data-mtst-no-support="typography">
                          ...
                          {/* .blog-post-s5-thumb */}
                          <div className="blog-post-s5-title">
                            <h2 data-mtst-selector=".blog-post-s5-title h2" data-mtst-label="Blog Post S5 - Title" data-mtst-no-support="background,border"><a href="http://meridianthemes-demo.net/the-essence/2016/04/07/heres-how-you-can-check-if-your-partner-is-cheating-on-tinder/">Here’s How You Can Check if Your Partner Is Cheating on Tinder</a></h2>
                          </div>
                          {/* .blog-post-s5-title */}
                          <div className="blog-post-s5-meta">
                            <div className="blog-post-s5-meta-author" data-mtst-selector=".blog-post-s5-meta-author" data-mtst-label="Blog Post S5 - Author" data-mtst-no-support="background,border">
                      ...
                      <div className="owl-item carousel-item-visible" style={{ width: 279 }}>
                        <div className="blog-post-s5 col col-3 carousel-item  post-79 post type-post status-publish format-standard has-post-thumbnail hentry category-beauty" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                          <div className="blog-post-s5-thumb" data-mtst-selector=".blog-post-s5-thumb" data-mtst-label="Blog Post S5 - Thumbnail" data-mtst-no-support="typography">
                      ...
                      <div className="owl-item carousel-item-visible" style={{ width: 279 }}>
                        <div className="blog-post-s5 col col-3 col-last carousel-item  post-39 post type-post status-publish format-standard has-post-thumbnail hentry category-travel tag-beauty tag-carousel tag-hair tag-style" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                          <div className="blog-post-s5-thumb" data-mtst-selector=".blog-post-s5-thumb" data-mtst-label="Blog Post S5 - Thumbnail" data-mtst-no-support="typography">
                      ...
                      <div className="owl-item" style={{ width: 279 }}>
                        <div className="blog-post-s5 col col-3 col-first carousel-item  post-27 post type-post status-publish format-standard has-post-thumbnail hentry category-beauty tag-carousel-small" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                          <div className="blog-post-s5-thumb" data-mtst-selector=".blog-post-s5-thumb" data-mtst-label="Blog Post S5 - Thumbnail" data-mtst-no-support="typography">
                          ...
                          {/* .blog-post-s5-thumb */}
                          <div className="blog-post-s5-title">
                            <h2 data-mtst-selector=".blog-post-s5-title h2" data-mtst-label="Blog Post S5 - Title" data-mtst-no-support="background,border"><a href="http://meridianthemes-demo.net/the-essence/2016/04/06/harry-styles-had-to-fend-off-selfie-seeking-fan-at-grandmothers-funeral/">Harry Styles Had to Fend Off Selfie-Seeking Fan at Grandmother’s Funeral</a></h2>
                          </div>
                          {/* .blog-post-s5-title */}
                          <div className="blog-post-s5-meta">
                            <div className="blog-post-s5-meta-author" data-mtst-selector=".blog-post-s5-meta-author" data-mtst-label="Blog Post S5 - Author" data-mtst-no-support="background,border">
                      ...
                      <div className="owl-item" style={{ width: 279 }}>
                        <div className="blog-post-s5 col col-3 carousel-item  post-38 post type-post status-publish format-standard has-post-thumbnail hentry category-personal tag-carousel" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                          <div className="blog-post-s5-thumb" data-mtst-selector=".blog-post-s5-thumb" data-mtst-label="Blog Post S5 - Thumbnail" data-mtst-no-support="typography">
                          ...
                          {/* .blog-post-s5-thumb */}
                          <div className="blog-post-s5-title">
                            <h2 data-mtst-selector=".blog-post-s5-title h2" data-mtst-label="Blog Post S5 - Title" data-mtst-no-support="background,border"><a href="http://meridianthemes-demo.net/the-essence/2016/04/06/leon-bridges-and-andra-day-rbs-rising-stars-talk-teaming-up/">Leon Bridges and Andra Day, R&amp;B’s Rising Stars, Talk Teaming Up</a></h2>
                          </div>
                          {/* .blog-post-s5-title */}
                          <div className="blog-post-s5-meta">
                            <div className="blog-post-s5-meta-author" data-mtst-selector=".blog-post-s5-meta-author" data-mtst-label="Blog Post S5 - Author" data-mtst-no-support="background,border">
                      ...
                      <div className="owl-item" style={{ width: 279 }}>
                        <div className="blog-post-s5 col col-3 carousel-item  post-36 post type-post status-publish format-standard has-post-thumbnail hentry category-personal tag-carousel" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                          <div className="blog-post-s5-thumb" data-mtst-selector=".blog-post-s5-thumb" data-mtst-label="Blog Post S5 - Thumbnail" data-mtst-no-support="typography">
                      ...
                      <div className="owl-item" style={{ width: 279 }}>
                        <div className="blog-post-s5 col col-3 col-last carousel-item  post-35 post type-post status-publish format-standard has-post-thumbnail hentry category-travel tag-beauty tag-carousel tag-hair tag-style" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                          <div className="blog-post-s5-thumb" data-mtst-selector=".blog-post-s5-thumb" data-mtst-label="Blog Post S5 - Thumbnail" data-mtst-no-support="typography">
                      ...
                      <div className="owl-item" style={{ width: 279 }}>
                        <div className="blog-post-s5 col col-3 col-first carousel-item  post-32 post type-post status-publish format-standard has-post-thumbnail hentry category-lifestyle tag-carousel-small" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                          <div className="blog-post-s5-thumb" data-mtst-selector=".blog-post-s5-thumb" data-mtst-label="Blog Post S5 - Thumbnail" data-mtst-no-support="typography">
                          ...
                          {/* .blog-post-s5-thumb */}
                          <div className="blog-post-s5-title">
                            <h2 data-mtst-selector=".blog-post-s5-title h2" data-mtst-label="Blog Post S5 - Title" data-mtst-no-support="background,border"><a href="http://meridianthemes-demo.net/the-essence/2016/04/06/republicans-say-theyre-embarrassed-by-trump-but-voting-for-him-anyway/">Republicans Say They’re Embarrassed by Trump but Voting for Him Anyway</a></h2>
                          </div>
                          {/* .blog-post-s5-title */}
                          <div className="blog-post-s5-meta">
                            <div className="blog-post-s5-meta-author" data-mtst-selector=".blog-post-s5-meta-author" data-mtst-label="Blog Post S5 - Author" data-mtst-no-support="background,border">
                      ...
                      <div className="owl-item" style={{ width: 279 }}>
                        <div className="blog-post-s5 col col-3 carousel-item  post-31 post type-post status-publish format-standard has-post-thumbnail hentry category-fashion tag-carousel-small" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                          <div className="blog-post-s5-thumb" data-mtst-selector=".blog-post-s5-thumb" data-mtst-label="Blog Post S5 - Thumbnail" data-mtst-no-support="typography">
                      ...
                      <div className="owl-item" style={{ width: 279 }}>
                        <div className="blog-post-s5 col col-3 carousel-item  post-30 post type-post status-publish format-standard has-post-thumbnail hentry category-beauty tag-carousel-small" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                          <div className="blog-post-s5-thumb" data-mtst-selector=".blog-post-s5-thumb" data-mtst-label="Blog Post S5 - Thumbnail" data-mtst-no-support="typography">
                      ...
                      <div className="owl-item" style={{ width: 279 }}>
                        <div className="blog-post-s5 col col-3 col-last carousel-item  post-28 post type-post status-publish format-standard has-post-thumbnail hentry category-fashion tag-carousel-small" style={{ paddingLeft: '14.9592px', paddingRight: '14.9592px' }}>
                          <div className="blog-post-s5-thumb" data-mtst-selector=".blog-post-s5-thumb" data-mtst-label="Blog Post S5 - Thumbnail" data-mtst-no-support="typography">
                          ...
                          {/* .blog-post-s5-thumb */}
                          <div className="blog-post-s5-title">
                            <h2 data-mtst-selector=".blog-post-s5-title h2" data-mtst-label="Blog Post S5 - Title" data-mtst-no-support="background,border"><a href="http://meridianthemes-demo.net/the-essence/2016/04/06/5-reasons-why-well-never-see-anything-like-the-o-j-simpson-verdict-again/">5 Reasons Why We’ll Never See Anything Like the O.J. Simpson Verdict Again</a></h2>
                          </div>
                          {/* .blog-post-s5-title */}
                          <div className="blog-post-s5-meta">
                            <div className="blog-post-s5-meta-author" data-mtst-selector=".blog-post-s5-meta-author" data-mtst-label="Blog Post S5 - Author" data-mtst-no-support="background,border">
                ...
                <div className="footer-widgets-1 col col-4">
                  <section id="text-2" className="widget widget_text">
                    <div className="textwidget">
                      ...
                      <h4>The Essence</h4>
                      <p>Tortor. Curabitur sed semper neque. Integer lectus arcu, ornare eu nisi sit amet, vehicula finibus odio. Nulla facilisi.
                  ...
                  <section id="tag_cloud-2" className="widget widget_tag_cloud">
                    ...
                    <div className="tagcloud"><a href="http://meridianthemes-demo.net/the-essence/tag/beauty/" className="tag-link-15 tag-link-position-1" title="6 topics" style={{ fontSize: '22pt' }}>beauty</a>
                      <a href="http://meridianthemes-demo.net/the-essence/tag/carousel/" className="tag-link-12 tag-link-position-2" title="5 topics" style={{ fontSize: '8pt' }}>carousel</a>
                      <a href="http://meridianthemes-demo.net/the-essence/tag/carousel-small/" className="tag-link-11 tag-link-position-3" title="6 topics" style={{ fontSize: '22pt' }}>carousel-small</a>
                      <a href="http://meridianthemes-demo.net/the-essence/tag/hair/" className="tag-link-16 tag-link-position-4" title="6 topics" style={{ fontSize: '22pt' }}>hair</a>
                      <a href="http://meridianthemes-demo.net/the-essence/tag/style/" className="tag-link-14 tag-link-position-5" title="6 topics" style={{ fontSize: '22pt' }}>style</a></div>
                  </section>
                </div>
                  ...
                  <section id="the_essence_subscribe_widget-2" className="widget widget_the_essence_subscribe_widget">
                    ...
                    <div className="subscribe-widget" style={{ backgroundImage: 'url(http://meridianthemes-demo.net/the-essence/wp-content/uploads/sites/4/2016/04/news-1.jpg)' }} data-mtst-selector=".subscribe-widget" data-mtst-label="Subscribe" data-mtst-no-support="typography">
                      <div className="subscribe-widget-inner" data-mtst-selector=".subscribe-widget-inner" data-mtst-label="Subscribe Inner" data-mtst-no-support="typography">
                        <h4 data-mtst-selector=".subscribe-widget h4" data-mtst-label="Subscribe Title" data-mtst-no-support="background,border">Receive My News Straight Into Your Inbox!</h4>
                        <div className="widget_wysija_cont shortcode_wysija">
                          <div id="msg-form-wysija-shortcode587e30801787a-1" className="wysija-msg ajax" />
        ...
        <div id="panel">
          ...
          {/* #panel-inner */}
          <span id="panel-close"><span className="fa fa-close" /></span>
        </div>
        {/* #panel */}
        <textarea style={{ display: 'none' }} id="mtst-panel-animation-data" defaultValue={""} />
      </div>
    )
  }
}
